...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item first" id="one"><a href="tschedule.php" class="main current"><span class="outer"><span class="inner dashboard"> Updeta Reserve  </span></span></a></li> 
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">Operator Reservation Update Car, hotel and site </h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
    ...
    <!--THIS IS A WIDE PORTLET-->
		<div class="portlet">
			...
			<label for="filter">Search</label> <input type="text" name="filter" value="" id="filter" /><a rel="facebox" href="add_schedules.php">update schedule</a>
			</div>
				...
				<?php
					...
					while($row = mysql_fetch_array($result))
		                ...
		                echo '<td><div align="left">'.$row['design'].'</div></td>';
							...
							echo '<td><div align="center"> <a rel="facebox" href="updateschedule.php?id='.$row['id'].'">edit</a> | <a href="deletorders.php?id='.$row['id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
							echo '</tr>';
						}
					?> 
