...
<div id="element" class="hero-body-index">
	<p><font color="white" align="center"><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;WELL COME TO OPERATOR LOGIN</br></h2></font></p>
	<form method="POST" >
	<table> 
    <tr><td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;User Name:</font>&nbsp;&nbsp;</td><td><input type="text"  name="user_name" class="user_name_hover" id="span9001" placeholder="User Name" required="required"></td></tr></br>
</br>
</br>
	<tr><td><td></tr>
...
<br><br><font color="white"><a href="forgetpassword1.php">forget Password?</a></font>
	</td></tr>
	<tr><td>
	</td><tr>
...
<?php
			...
			$login_query=mysql_query("select * from users where user_name='$user_name' and password='$password' and user_type='operator'");
