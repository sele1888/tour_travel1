...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item last" id="eight"><a href="ttsite.php" class="main  current"><span class="outer"><span class="inner settings">toursit site</span></span></a></li>  
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">tourist  View Tourist Site</h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
    ...
    <!--THIS IS A WIDE PORTLET-->
		<div class="portlet">
			...
			<a rel="facebox" href="showtot.php">Tourist site reservation</a> 
			</div>
