...
<div id="menu">
	<ul class="group" id="menu_group_main">
	 <li class="item first" id="one"><a href="hotel.php" class="main current"><span class="outer"><span class="inner dashboard"> Hotel  </span></span></a></li>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">Hotel Manages</h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
    ...
    <!--THIS IS A WIDE PORTLET-->
		<div class="portlet">
			...
			<a rel="facebox" href="addhotel.php">Add hotel</a>
			</div>
			...
			<form action="" method="post">
					...
					<table cellpadding="1" cellspacing="1" id="resultTable">
						<thead>
							<tr>
								<th  style="border-left: 1px solid #C1DAD7"> Hotel Name</th>
                            <th> Total Room </th>
								<th> Room Number </th>
								<th> Category </th>
								<th>Price </th>
							...
							while($row = mysql_fetch_array($result))
								{
									...
									echo '<td><div align="left">'.$row['totalroom'].'</div></td>';
									...
									echo '<td><a rel="facebox" href="edithoteltimage.php?id='.$row['id'].'"><img src="img/products/'.$row['img'].'" width="50" height="50"></a></td>';
									echo '<td><div align="center"><a rel="facebox" href="edit_hotel.php?id='.$row['id'].'">edit</a> | <a href="deletehotel.php?id='.$row['id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
