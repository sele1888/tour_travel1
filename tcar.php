...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item middle" id="four"><a href="tcar.php" class="main  current"><span class="outer"><span class="inner media_library">car</span></span></a></li>         
    </ul>
</div>
<!-- MENU END -->
</div>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard"> Tourist view  cars</h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
