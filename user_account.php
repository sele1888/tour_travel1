...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item middle" id="four"><a href="user_account.php" class="main current"><span class="outer"><span class="inner media_library"> Account</span></span></a></li>
		<li class="item first" id="one"><a href="admin.php" class="main"><span class="outer"><span class="inner dashboard"> Tourist reserve</span></span></a></li>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">view operator profile and prapred schedule </h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
    ...
    <!--THIS IS A WIDE PORTLET-->
		<div class="portlet">
			...
			<a rel="facebox" href="add_user.php">Add user</a>
			</div>
			...
			<?php
				include('connect.php');
						...
						echo '<td style="border-left: 1px solid #C1DAD7;">'.$row['first_name'].'</td>';
						echo '<td><div align="left">'.$row['last_name'].'</div></td>';
						...
						echo '<td><div align="left">'.$row['ability'].'</div></td>';
						echo '<td><div align="left">'.$row['user_type'].'</div></td>';
						
						echo '<td><div align="center"><a rel="facebox" href="edit_user.php?user_id='.$row['user_id'].'">edit</a> | <a href="delete_user.php?user_id='.$row['user_id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
