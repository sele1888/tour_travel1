...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item last" id="eight"><a href="tsite.php" class="main current "><span class="outer"><span class="inner settings">Toursit site</span></span></a></li>   
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard"> Manages Tourist sites</h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
    ...
    <!--THIS IS A WIDE PORTLET-->
		<div class="portlet">
			...
			<a rel="facebox" href="addtsite.php">Add tourist site</a>
			</div>
							...
							while($row = mysql_fetch_array($result))
								{
									...
									echo '<td><a rel="facebox" href="edittsiteimage.php?id='.$row['id'].'"><img src="img/products/'.$row['img'].'" width="80" height="50"></a></td>';
									echo '<td><div align="center"><a rel="facebox" href="edit_tsite.php?id='.$row['id'].'">edit</a> | <a href="deletetsite.php"?id="'.$row['id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
