...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item middle" id="four"><a href="aprofil.php" class="main current"><span class="outer"><span class="inner media_library">Profile</span></span></a></li>       
    </ul>
</div>
<!-- MENU END -->
</div>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">Operator profile </h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
				...
				while($row = mysql_fetch_array($result))
					{
						...
						echo '<td><div align="center"><a href="#" class="delbutton" title="Click To Delete">delete</a></div></td>';
						echo '</tr>';
					}
				?> 
				</tbody>
