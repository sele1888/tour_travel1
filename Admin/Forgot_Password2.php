...
<?php
	...
	$que0=mysql_query("select sequrity_q from users where user_name='$user_name'");
	$rec0=mysql_fetch_row($que0);
	$userid=$rec0[0];
	$count1=mysql_num_rows($que0);
	if($count1>0)
	{
		$que1=mysql_query("select * from users where user_id=$userid");
...
<form action="Forgot_Password3.php"  method="post"> 
	...
	<div style="position:absolute; left:310px; top:203px;">  
  <input type="text" name="ans1" style="height:28; font-size:16px; height:35; width:300;">  </div>
