...
<!-- USER TOOLS START -->
     ...
     <div id="user_tools"><span><a  href="edit_user.php">Edit profile</a></span></div>
    </div>
<!-- USER TOOLS END -->    
...
<!-- CONTENT START -->
    ...
    <!--THIS IS A WIDE PORTLET-->
		<div class="portlet">
			...
			<a rel="facebox" href="viewreports.php">view report</a>
				...
				<?php
					...
					while($row = mysql_fetch_array($result))
		                ...
		                echo '<td><div align="left">'.$row['design'].'</div></td>';
							...
							echo '<td><div align="center"><a rel="facebox" href="vieworders.php?id='.$row['confirmation'].'" title="Click To View Orders">View Orders</a> | <a rel="facebox" href="viewreport.php?id='.$row['confirmation'].'" title="Click To View Orders">Print</a> | <a rel="facebox" href="editstatus.php?id='.$row['id'].'">edit</a> | <a href="#" id="'.$row['id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
							echo '</tr>';
						}
					?> 
				</tbody>
