...
<div style="position:absolute;left:72.75%; top:30.8%; height:44.3%; width:0.10%; background-color:#000000; "> </div>
 ...
 <form action="Forgot_Password4.php"  method="post"> 
	...
	<div style="position:absolute; left:316px; top:202px;">  
   <input type="text" name="ans2" style="height:28; font-size:16px; height:35; width:300;">  </div>
	<input type="hidden" value="<?php echo $userid; ?>" name="userid">
	<div style="position:absolute; left:286px; top:258px;">  
   <input type="submit" name="Next" value="Next" id="next"> </div>
</form>
