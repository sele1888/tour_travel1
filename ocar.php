...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item first" id="one"><a href="ocar.php" class="main current"><span class="outer"><span class="inner dashboard"> car reserv  </span></span></a></li>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard"> Operator view  cars</h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
		...
		<div class="portlet">
			...
			<form action="" method="post">
					...
					<table cellpadding="1" cellspacing="1" id="resultTable">
						<thead>
							<tr>
								<th  style="border-left: 1px solid #C1DAD7"> carBaordnumber </th>
								<th> carSideNumber </th>
								<th> carlevel </th>
								<th> carCurrentCity </th>
								<th> price </th>
								<th> Images </th>
