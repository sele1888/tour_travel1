...
<!--  <div id="user_tools"><span><a  href="http://localhost/tour/home/admin/Change/index.php">Edit profile</a></span></div> -->
    </div>
<!-- USER TOOLS END -->    
...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item middle" id="four"><a href="tmessage.php" class="main  current"><span class="outer"><span class="inner media_library"> comment</span></span></a></li>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">Comment of tourist  </h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
...
<a rel="facebox" href="addmessage.php">comment</a>
			</div>
				...
				while($row = mysql_fetch_array($result))
					{
						...
						echo '<td><div align="left">'.$row['message'].'</div></td>';
								echo '<td><div align="center"><a rel="facebox" href="editmassage.php?id='.$row['message_id'].'">edit</a> | <a href="deletemessage.php?id="'.$row['message_id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
						echo '</tr>';
					}
				?> 
				</tbody>
...
Developers:tour and travel guiding team &copy;&nbsp;2016&nbsp;Copy Right Reserved 2008 e.c</div>
<!-- FOOTER END -->
