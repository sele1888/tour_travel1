...
<!-- HIDDEN COLOR CHANGER -->      
  	...
  	<!--LOGO-->
	<div class="grid_8" id="logo">Operatour pages</div>
    <div class="grid_8">
<!-- USER TOOLS START -->
...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item first" id="one"><a href="oschedule.php" class="main current"><span class="outer"><span class="inner dashboard"> Updeta Reserv  </span></span></a></li>      
    </ul>
</div>
<!-- MENU END -->
</div>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">Reservation Update Car hotel and site </h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
				...
				<?php
					...
					while($row = mysql_fetch_array($result))
		                ...
		                echo '<td><div align="left">'.$row['design'].'</div></td>';
							...
							echo '<td><div align="center"> <a rel="facebox" href="#"></a> | <a href="#" class="delbutton" title="Click To Delete"></a></div></td>';
							echo '</tr>';
						}
					?>
				</tbody>
