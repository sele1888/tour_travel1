...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item first" id="one"><a href="thotel.php" class="main  current"><span class="outer"><span class="inner dashboard"> hotel  </span></span></a></li>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">Tourist View hotel </h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
