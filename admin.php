...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item first" id="one"><a href="admin.php" class="main current"><span class="outer"><span class="inner dashboard"> Tourist reserv </span></span></a></li>
		<li class="item middle" id="four"><a href="car.php" class="main"><span class="outer"><span class="inner media_library">Car</span></span></a></li>  
		...
		<li class="item middle" id="four"><a href="aprofil.php" class="main"><span class="outer"><span class="inner media_library">Profie</span></span></a></li>         
    </ul>
</div>
<!-- MENU END -->
</div>
...
<!-- CONTENT START -->
    ...
    <!--THIS IS A WIDE PORTLET-->
		<div class="portlet">
			...
			<a href="#" title="Click To View report">View login</a> 
				...
				<?php
					...
					while($row = mysql_fetch_array($result))
		                ...
		                echo '<td><div align="left">'.$row['design'].'</div></td>';
							...
							echo '<td><div align="center"><a rel="facebox" href="prints.php?id='.$row['firstname'].'" title="Click To View report">report</a> |<a rel="facebox" href="vieworders.php?id='.$row['id'].'" title="Click To View Orders">View</a> | <a rel="facebox" href="viewreport.php?id='.$row['firstname'].'" title="Click To View Orders">Print</a> | <a href="deletorders.php?id='.$row['id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
							echo '</tr>';
						}
					?> 
				</tbody>
...
//Built a url to send
var info = 'id=' + del_id;
 if(confirm("Sure you want to delete this  reservation ? There is NO click Cancel or YES Click OK!"))
		  {
 ...
 $.ajax({
   ...
   success: function(){
         ...
         $(this).parents(".record").animate({ backgroundColor: "#cceeff" }, "fast")
