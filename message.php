...
<!-- HIDDEN COLOR CHANGER -->      
    ...
    <div class="grid_8">
<!-- USER TOOLS START -->
      <div id="user_tools"><span><a   href="../home/index.php">Logout</a></span></div>
...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item middle" id="four"><a href="message.php" class="main current"><span class="outer"><span class="inner media_library"> Comment</span></span></a></li>
