...
<!-- HIDDEN COLOR CHANGER -->      
    ...
    <div class="grid_8">
<!-- USER TOOLS START -->
      <div id="user_tools"><span><a  href="logout.php">Logout</a></span></div>    </div>
<!-- USER TOOLS END -->    
...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item middle" id="four"><a href="messages.php" class="main current"><span class="outer"><span class="inner media_library">Message</span></span></a></li>  
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">view message send to the tourist </h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
				...
				while($row = mysql_fetch_array($result))
					{
						...
						echo '<td><div align="center"><a href="deletemessage.php?message_id='.$row['message_id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
						echo '</tr>';
					}
				?> 
				</tbody>
...
Developers:tour and travel guiding team &copy;&nbsp;2015&nbsp;Copy Right Reserved 2007 e.c</div>
<!-- FOOTER END -->
